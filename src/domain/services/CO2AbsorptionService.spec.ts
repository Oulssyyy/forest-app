...
describe('CO2AbsorptionService', () => {
    ...
    const tree1: Tree = { id: 't1', birth: new Date(), species: Species.OAK, exposure: Exposure.SUNNY, carbonStorageCapacity: 10 };
    const tree2: Tree = { id: 't2', birth: new Date(), species: Species.ASH, exposure: Exposure.SUNNY, carbonStorageCapacity: 20 };
